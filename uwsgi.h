...
int uwsgi_hooked_parse_dict_dgram(int, char *, size_t, uint8_t, uint8_t,
                                  void (*)(char *, uint16_t, char *, uint16_t, void *), void *);
...
struct uwsgi_subscribe_node *uwsgi_get_subscribe_node_by_name(struct uwsgi_subscribe_slot **, char *, uint16_t, char *,
                                                              uint16_t);
...
void uwsgi_send_subscription_from_fd(int, char *, char *, size_t, uint8_t, uint8_t, uint8_t, char *, char *, char *,
                                     char *, char *);
...
struct uwsgi_stats_pusher *uwsgi_register_stats_pusher(char *,
                                                       void (*)(struct uwsgi_stats_pusher_instance *, time_t, char *,
                                                                size_t));
...
void uwsgi_register_imperial_monitor(char *, void (*)(struct uwsgi_emperor_scanner *),
                                     void (*)(struct uwsgi_emperor_scanner *));
...
void uwsgi_register_alarm(char *, void (*)(struct uwsgi_alarm_instance *),
...
struct uwsgi_offload_engine *uwsgi_offload_register_engine(char *, int (*)(struct wsgi_request *,
                                                                           struct uwsgi_offload_request *),
                                                           int (*)(struct uwsgi_thread *,
                                                                   struct uwsgi_offload_request *, int));
...
struct uwsgi_exception_handler *uwsgi_register_exception_handler(char *,
                                                                 int (*)(struct uwsgi_exception_handler_instance *,
                                                                         char *, size_t));

char *proxy1_parse(char *ptr, char *watermark, char **src, uint16_t *src_len, char **dst, uint16_t *dst_len,
                   char **src_port, uint16_t *src_port_len, char **dst_port, uint16_t *dst_port_len);
...
struct uwsgi_route_var *uwsgi_register_route_var(char *,
                                                 char *(*)(struct wsgi_request *, char *, uint16_t, uint16_t *));
...
struct uwsgi_transformation *uwsgi_add_transformation(struct wsgi_request *wsgi_req,
                                                      int (*func)(struct wsgi_request *, struct uwsgi_transformation *),
                                                      void *);
