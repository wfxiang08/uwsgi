...
static struct uwsgi_option uwsgi_base_options[] =
        {{"socket", required_argument, 's', "bind to the specified UNIX/TCP socket using default protocol",
          uwsgi_opt_add_socket, NULL, 0},
         {"uwsgi-socket", required_argument, 's',
         ...
         {"raw-socket", required_argument, 0,
          ...
          uwsgi_opt_add_socket_no_defer, "raw", 0},
         {"raw-modifier1",
          required_argument, 0,
          "force the specified modifier1 when using RAW protocol",
          uwsgi_opt_set_64bit, &uwsgi.raw_modifier1, 0},
         {"raw-modifier2",
          required_argument,
          0,
         ...
         {"protocol", required_argument, 0, "force the specified protocol for default sockets",
          uwsgi_opt_set_str, &uwsgi.protocol, 0},
         {"socket-protocol",
          required_argument, 0,
          "force the specified protocol for default sockets",
          uwsgi_opt_set_str,
          &uwsgi.protocol, 0},
         {"shared-socket", required_argument, 0,
         ...
         {"thunder-lock", no_argument, 0,
          ...
          &uwsgi.use_thunder_lock, 0}, {"harakiri", required_argument, 't',
                                        ...
                                        &uwsgi.harakiri_options.workers, 0}, {"harakiri-verbose", no_argument,
                                                                              0, "enable verbose mode for harakiri",
                                                                              uwsgi_opt_true,
                                                                              &uwsgi.harakiri_verbose, 0},
         {"harakiri-no-arh", no_argument, 0,
          ...
          &uwsgi.harakiri_no_arh, 0}, {"no-harakiri-arh", no_argument, 0,
                                       ...
                                       &uwsgi.harakiri_no_arh, 0}, {"no-harakiri-after-req-hook",
                                                                    ...
                                                                    uwsgi_opt_true, &uwsgi.harakiri_no_arh, 0},
         {"backtrace-depth",
         ...
         {"config", required_argument, 0, "load configuration using the pluggable system",
          uwsgi_opt_load_config, NULL, UWSGI_OPT_IMMEDIATE}, {"fallback-config",
                                                              ...
                                                              uwsgi_opt_set_str, &uwsgi.fallback_config,
                                                              UWSGI_OPT_IMMEDIATE}, {
         ...
         {"set", required_argument, 'S', "set a placeholder or an option",
          uwsgi_opt_set_placeholder, NULL, UWSGI_OPT_IMMEDIATE}, {
                 ...
                 uwsgi_opt_set_placeholder, (void *) 1, UWSGI_OPT_IMMEDIATE}, {"get",
                                                                               ...
                                                                               &uwsgi.get_list, UWSGI_OPT_NO_INITIAL}, {
         ...
         {"if-opt", required_argument, 0, "(opt logic) check for option", uwsgi_opt_logic,
          (void *) uwsgi_logic_opt_if_opt, UWSGI_OPT_IMMEDIATE}, {"if-not-opt",
                                                                  required_argument, 0, "(opt logic) check for option",
                                                                  uwsgi_opt_logic,
                                                                  (void *) uwsgi_logic_opt_if_not_opt,
                                                                  UWSGI_OPT_IMMEDIATE},
         ...
         {"if-not-file", required_argument, 0, "(opt logic) check for file existance",
          ...
          UWSGI_OPT_IMMEDIATE}, {"if-dir", required_argument, 0,
                                 ...
                                 (void *) uwsgi_logic_opt_if_dir, UWSGI_OPT_IMMEDIATE}, {"if-not-dir",
                                                                                         ...
                                                                                         uwsgi_opt_logic,
                                                                                         (void *) uwsgi_logic_opt_if_not_dir,
                                                                                         UWSGI_OPT_IMMEDIATE},
         ...
         {"blacklist", required_argument, 0, "set options blacklist context", uwsgi_opt_set_str,
          &uwsgi.blacklist_context, UWSGI_OPT_IMMEDIATE}, {"end-blacklist",
                                                           no_argument, 0, "clear options blacklist context",
                                                           uwsgi_opt_set_null,
         ...
         {"whitelist", required_argument, 0, "set options whitelist context", uwsgi_opt_set_str,
          &uwsgi.whitelist_context, UWSGI_OPT_IMMEDIATE}, {"end-whitelist",
                                                           no_argument, 0, "clear options whitelist context",
                                                           uwsgi_opt_set_null,
         ...
         {"inherit", required_argument, 0, "use the specified file as config template",
          uwsgi_opt_load, NULL, 0}, {"include", required_argument, 0,
                                     ...
                                     NULL, UWSGI_OPT_IMMEDIATE}, {"inject-before", required_argument, 0,
                                                                  ...
                                                                  uwsgi_opt_add_string_list, &uwsgi.inject_before,
                                                                  UWSGI_OPT_IMMEDIATE},
         {"inject-after", required_argument, 0,
          ...
          uwsgi_opt_add_string_list, &uwsgi.inject_after, UWSGI_OPT_IMMEDIATE}, {
                 ...
                 uwsgi_opt_set_str, &uwsgi.daemonize, 0}, {"daemonize2",
                                                           ...
                                                           uwsgi_opt_set_str, &uwsgi.daemonize2, 0},
         {"stop", required_argument,
         ...
         {"chmod", optional_argument, 'C', "chmod-socket", uwsgi_opt_chmod_socket, NULL, 0}, {
                 ...
                 uwsgi_opt_set_str, &uwsgi.chown_socket, 0}, {"umask",
                                                              required_argument, 0, "set umask", uwsgi_opt_set_umask,
                                                              NULL,
                                                              UWSGI_OPT_IMMEDIATE},
#ifdef __linux__
         ...
         {"map-socket", required_argument, 0, "map sockets to specific workers",
          uwsgi_opt_add_string_list, &uwsgi.map_socket, 0}, {"enable-threads",
                                                             no_argument, 'T', "enable threads", uwsgi_opt_true,
                                                             &uwsgi.has_threads,
         ...
         {"auto-procname", no_argument, 0,
          ...
          uwsgi_opt_true, &uwsgi.auto_procname, 0}, {"procname-prefix",
                 ...
                 &uwsgi.procname_prefix, UWSGI_OPT_PROCNAME}, {"procname-append",
                                                               ...
                                                               uwsgi_opt_set_str, &uwsgi.procname_append,
                                                               UWSGI_OPT_PROCNAME}, {
          ...
          &uwsgi.single_interpreter, 0}, {"need-app", no_argument, 0,
                 ...
                 &uwsgi.emperor_proxy, 0}, {"emperor-wrapper", required_argument, 0,
                                            ...
                                            &uwsgi.emperor_wrapper, 0}, {"emperor-wrapper-override",
                                                                         ...
                                                                         uwsgi_opt_add_string_list,
                                                                         &uwsgi.emperor_wrapper_override, 0}, {
          ...
          uwsgi_opt_set_int, &uwsgi.emperor_heartbeat, 0}, {
                 ...
                 &uwsgi.emperor_curse_tolerance, 0}, {"emperor-pidfile",
                                                      ...
                                                      uwsgi_opt_set_str, &uwsgi.emperor_pidfile, 0}, {"emperor-tyrant",
                                                                                                      ...
                                                                                                      0},
         {"emperor-tyrant-nofollow", no_argument, 0,
          ...
          uwsgi_opt_true, &uwsgi.emperor_tyrant_nofollow, 0}, {"emperor-stats",
                                                               required_argument, 0, "run the Emperor stats server",
                                                               uwsgi_opt_set_str,
                                                               &uwsgi.emperor_stats, 0},
         {"emperor-stats-server", required_argument,
         ...
         {"cache", required_argument, 0, "create a shared cache containing given elements",
          uwsgi_opt_set_64bit, &uwsgi.cache_max_items, 0}, {"cache-blocksize",
                                                            required_argument, 0, "set cache blocksize",
                                                            uwsgi_opt_set_64bit,
                                                            &uwsgi.cache_blocksize, 0},
         {"cache-store", required_argument, 0,
          ...
          &uwsgi.cache_store, UWSGI_OPT_MASTER}, {"cache-store-sync",
                                                  ...
                                                  uwsgi_opt_set_int, &uwsgi.cache_store_sync, 0}, {"cache-no-expire",
                                                                                                   ...
                                                                                                   uwsgi_opt_true,
                                                                                                   &uwsgi.cache_no_expire,
                                                                                                   0},
         {"cache-expire-freq", required_argument,
         ...
         {"spooler-ordered", no_argument, 0, "try to order the execution of spooler tasks",
          uwsgi_opt_true, &uwsgi.spooler_ordered, 0}, {"spooler-chdir",
                                                       ...
                                                       uwsgi_opt_set_str, &uwsgi.spooler_chdir, 0},
         {"spooler-processes",
          ...
          uwsgi_opt_set_int, &uwsgi.spooler_numproc, UWSGI_OPT_IMMEDIATE}, {
                 ...
                 uwsgi_opt_true, &uwsgi.spooler_quiet, 0}, {"spooler-max-tasks",
                                                            ...
                                                            uwsgi_opt_set_int, &uwsgi.spooler_max_tasks, 0},
         {"spooler-harakiri",
          ...
          uwsgi_opt_set_int, &uwsgi.harakiri_options.spoolers, 0}, {
                 ...
                 uwsgi_opt_set_int, &uwsgi.spooler_frequency, 0}, {"spooler-freq",
                                                                   required_argument, 0, "set spooler frequency",
                                                                   uwsgi_opt_set_int,
         ...
         {"mules", required_argument, 0, "add the specified number of mules",
          uwsgi_opt_add_mules, NULL, UWSGI_OPT_MASTER}, {"farm",
                                                         required_argument, 0, "add a mule farm", uwsgi_opt_add_farm,
                                                         NULL,
                                                         UWSGI_OPT_MASTER}, {"mule-msg-size", optional_argument, 0,
                                                                             "set mule message buffer size",
                                                                             uwsgi_opt_set_int, &uwsgi.mule_msg_size,
                                                                             UWSGI_OPT_MASTER},
         ...
         {"pidfile", required_argument, 0, "create pidfile (before privileges drop)",
          uwsgi_opt_set_str, &uwsgi.pidfile, 0}, {"pidfile2", required_argument,
                                                  ...
                                                  &uwsgi.pidfile2, 0}, {"chroot", required_argument, 0,
                                                                        ...
                                                                        uwsgi_opt_set_str, &uwsgi.chroot,
                                                                        0},
#ifdef __linux__
         ...
         {"refork", no_argument, 0,
          ...
          uwsgi_opt_true, &uwsgi.refork, 0}, {"re-fork", no_argument, 0,
                                              ...
                                              uwsgi_opt_true, &uwsgi.refork, 0}, {"refork-as-root", no_argument, 0,
                                                                                  ...
                                                                                  uwsgi_opt_true, &uwsgi.refork_as_root,
                                                                                  0}, {"re-fork-as-root",
                                                                                       no_argument, 0,
                                                                                       "fork() again before privileges drop. Useful for jailing systems",
                                                                                       uwsgi_opt_true,
                                                                                       &uwsgi.refork_as_root, 0},
         {"refork-post-jail",
          no_argument, 0,
          ...
          uwsgi_opt_add_string_list, &uwsgi.hook_asap, 0}, {"hook-pre-jail",
                 ...
                 &uwsgi.hook_pre_app, 0}, {"hook-post-app", required_argument, 0,
                                           ...
                                           &uwsgi.hook_post_app, 0}, {"hook-post-fork", required_argument, 0,
                                                                      ...
                                                                      uwsgi_opt_add_string_list,
                                                                      &uwsgi.hook_post_fork, 0},
         {"hook-accepting", required_argument, 0,
         ...
         {"exec-asap", required_argument, 0, "run the specified command as soon as possible",
          uwsgi_opt_add_string_list, &uwsgi.exec_asap, 0}, {"exec-pre-jail",
                 ...
                 uwsgi_opt_add_string_list, &uwsgi.exec_pre_app, 0}, {"exec-post-app",
                                                                      ...
                                                                      uwsgi_opt_add_string_list, &uwsgi.exec_post_app,
                                                                      0},
         ...
         {"call-asap", required_argument, 0, "call the specified function as soon as possible",
          uwsgi_opt_add_string_list, &uwsgi.call_asap, 0}, {"call-pre-jail",
                 ...
                 uwsgi_opt_add_string_list, &uwsgi.call_pre_app, 0}, {"call-post-app",
                                                                      ...
                                                                      uwsgi_opt_add_string_list, &uwsgi.call_post_app,
                                                                      0},
         ...
         {"so-keepalive", no_argument, 0,
          "enable TCP KEEPALIVEs", uwsgi_opt_true, &uwsgi.so_keepalive, 0}, {
                 ...
                 uwsgi_opt_set_int, &uwsgi.so_send_timeout, 0}, {"socket-sndbuf",
                                                                 required_argument, 0, "set SO_SNDBUF",
                                                                 uwsgi_opt_set_64bit,
                                                                 &uwsgi.so_sndbuf, 0},
         {"socket-rcvbuf", required_argument, 0,
          "set SO_RCVBUF", uwsgi_opt_set_64bit, &uwsgi.so_rcvbuf, 0}, {
                 ...
                 uwsgi_opt_set_megabytes, &uwsgi.rl.rlim_max, 0}, {"limit-nproc",
                                                                   ...
                                                                   uwsgi_opt_set_int, &uwsgi.rl_nproc.rlim_max, 0},
         {"reload-on-as",
          required_argument, 0,
         ...
         {"upload-progress", required_argument, 0,
          ...
          uwsgi_opt_set_str, &uwsgi.upload_progress, 0}, {"no-default-app",
                                                          no_argument, 0, "do not fallback to default app",
                                                          uwsgi_opt_true,
                                                          &uwsgi.no_default_app, 0},
         {"manage-script-name", no_argument, 0,
         ...
         {"metrics-dir",
          ...
          uwsgi_opt_set_str, &uwsgi.metrics_dir, UWSGI_OPT_METRICS
                                                 | UWSGI_OPT_MASTER}, {"metrics-dir-restore",
                                                                       ...
                                                                       uwsgi_opt_true, &uwsgi.metrics_dir_restore,
                                                                       UWSGI_OPT_METRICS
                                                                       | UWSGI_OPT_MASTER},
         {"metric-dir", required_argument,
         ...
         {"udp", required_argument, 0, "run the udp server on the specified address",
          uwsgi_opt_set_str, &uwsgi.udp_socket, UWSGI_OPT_MASTER}, {"stats",
                                                                    ...
                                                                    uwsgi_opt_set_str,
                                                                    &uwsgi.stats, UWSGI_OPT_MASTER},
         {"stats-server", required_argument,
          ...
          uwsgi_opt_set_str, &uwsgi.stats, UWSGI_OPT_MASTER}, {"stats-http",
                 ...
                 UWSGI_OPT_MASTER | UWSGI_OPT_METRICS}, {"stats-pusher-default-freq",
                                                         ...
                                                         uwsgi_opt_set_int, &uwsgi.stats_pusher_default_freq,
                                                         UWSGI_OPT_MASTER},
                                                            ...
                                                            uwsgi_opt_true, &uwsgi.stats_no_metrics, UWSGI_OPT_MASTER},
         {
                 ...
                 &uwsgi.multicast_group, UWSGI_OPT_MASTER}, {"multicast-ttl",
                                                             required_argument, 0, "set multicast ttl",
                                                             uwsgi_opt_set_int,
                                                             &uwsgi.multicast_ttl, 0},
         {"multicast-loop", required_argument, 0,
         ...
         {"log-format",
          ...
          uwsgi_opt_set_str, &uwsgi.logformat, 0}, {"logformat",
                                                    ...
                                                    uwsgi_opt_set_str, &uwsgi.logformat, 0}, {"logformat-strftime",
                                                                                              ...
                                                                                              uwsgi_opt_true,
                                                                                              &uwsgi.logformat_strftime,
                                                                                              0},
         {"log-format-strftime", no_argument, 0,
          ...
          &uwsgi.logformat_strftime, 0}, {"logfile-chown", no_argument, 0,
                 ...
                 uwsgi_opt_logfile_chmod, NULL, 0}, {"log-syslog", optional_argument,
                                                     0, "log to syslog", uwsgi_opt_set_logger, "syslog",
                                                     UWSGI_OPT_MASTER
                                                     | UWSGI_OPT_LOG_MASTER},
         ...
         {"req-logger", required_argument, 0, "set/append a request logger",
          uwsgi_opt_set_req_logger, NULL, UWSGI_OPT_REQ_LOG_MASTER}, {
                 ...
                 uwsgi_opt_set_req_logger, NULL, UWSGI_OPT_REQ_LOG_MASTER}, {"logger",
                                                                             required_argument, 0,
                                                                             "set/append a logger",
                                                                             uwsgi_opt_set_logger, NULL,
                                                                             UWSGI_OPT_MASTER | UWSGI_OPT_LOG_MASTER},
         {"logger-list", no_argument,
         ...
         {"alarm-list", no_argument, 0, "list enabled alarms", uwsgi_opt_true,
          &uwsgi.alarms_list, 0}, {"alarms-list", no_argument, 0,
                 ...
                 uwsgi_opt_set_64bit, &uwsgi.alarm_msg_size, 0}, {"log-master",
                                                                  no_argument, 0, "delegate logging to master process",
                                                                  uwsgi_opt_true,
                                                                  &uwsgi.log_master,
                                                                  UWSGI_OPT_MASTER | UWSGI_OPT_LOG_MASTER},
         ...
         {"log-zero", no_argument, 0, "log responses without body", uwsgi_opt_true,
          &uwsgi.logging_options.zero, 0}, {"log-slow", required_argument, 0,
                                            ...
                                            uwsgi_opt_set_int, &uwsgi.logging_options.slow, 0}, {"log-4xx",
                                                                                                 ...
                                                                                                 uwsgi_opt_true,
                                                                                                 &uwsgi.logging_options._4xx,
                                                                                                 0},
         {"log-5xx", no_argument, 0,
          ...
          &uwsgi.logging_options._5xx, 0}, {"log-big", required_argument, 0,
                                            ...
                                            &uwsgi.logging_options.big, 0}, {"log-sendfile", required_argument, 0,
                                                                             ...
                                                                             &uwsgi.logging_options.sendfile, 0},
         {"log-ioerror",
          ...
          &uwsgi.logging_options.ioerror, 0}, {"log-micros", no_argument, 0,
                                               ...
                                               uwsgi_opt_true, &uwsgi.log_micros, 0}, {"log-x-forwarded-for",
                                                                                       ...
                                                                                       uwsgi_opt_true,
                                                                                       &uwsgi.logging_options.log_x_forwarded_for,
                                                                                       0}, {
         ...
         {"force-cwd", required_argument, 0,
          ...
          uwsgi_opt_set_str, &uwsgi.force_cwd, 0}, {"binsh", required_argument,
                ...
                // 有两次chdir的机会
         {"chdir", required_argument, 0, "chdir to specified directory before apps loading", uwsgi_opt_set_str,
          &uwsgi.chdir, 0},
         {"chdir2", required_argument, 0, "chdir to specified directory after apps loading", uwsgi_opt_set_str,
          &uwsgi.chdir2, 0},

                // 默认是lazy的，各个worker加载自己的代码
                // lazy为true, 那么各个worker的加载可以独立进行，不同的woker可以先后重启
                // lazy为false, 则master可以先加载，然后在fork worker, fork时代价小
         {"lazy", no_argument, 0, "set lazy mode (load apps in workers instead of master)", uwsgi_opt_true, &uwsgi.lazy,
          0},
         {"lazy-apps", no_argument, 0, "load apps in each worker instead of the master", uwsgi_opt_true,
          &uwsgi.lazy_apps, 0},

         {"cheap", no_argument, 0, "set cheap mode (spawn workers only after the first request)", uwsgi_opt_true,
          &uwsgi.status.is_cheap, UWSGI_OPT_MASTER},
         {"cheaper", required_argument, 0, "set cheaper mode (adaptive process spawning)", uwsgi_opt_set_int,
          &uwsgi.cheaper_count, UWSGI_OPT_MASTER | UWSGI_OPT_CHEAPER},
         {"cheaper-initial", required_argument, 0, "set the initial number of processes to spawn in cheaper mode",
          uwsgi_opt_set_int, &uwsgi.cheaper_initial, UWSGI_OPT_MASTER | UWSGI_OPT_CHEAPER},
         {"cheaper-algo", required_argument, 0, "choose to algorithm used for adaptive process spawning",
          ...
          uwsgi_opt_true, &uwsgi.close_on_exec2, 0}, {"mode", required_argument,
                 ...
                 uwsgi_opt_set_env, NULL, 0}, {"envdir", required_argument, 0,
                                               ...
                                               &uwsgi.envdirs, 0}, {"early-envdir", required_argument, 0,
                                                                    ...
                                                                    uwsgi_opt_envdir, NULL,
                                                                    UWSGI_OPT_IMMEDIATE},
         {"unenv", required_argument, 0,
         ...
         {"tcp-fastopen",
          ...
          uwsgi_opt_set_int, &uwsgi.tcp_fast_open, 0}, {"tcp-fast-open-client",
                 ...
                 uwsgi_opt_true, &uwsgi.tcp_fast_open_client, 0}, {"zerg",
                                                                   ...
                                                                   uwsgi_opt_add_string_list, &uwsgi.zerg_node, 0},
         {"zerg-fallback",
          no_argument, 0,
         ...
         {"daemons-honour-stdin", no_argument, 0,
          ...
          uwsgi_opt_true, &uwsgi.daemons_honour_stdin, UWSGI_OPT_MASTER}, {
                 ...
                 uwsgi_opt_add_daemon2, NULL, UWSGI_OPT_MASTER}, {"plugins",
                                                                  required_argument, 0, "load uWSGI plugins",
                                                                  uwsgi_opt_load_plugin, NULL,
                                                                  UWSGI_OPT_IMMEDIATE},
                                                                               ...
                                                                               &uwsgi.plugins_dir, UWSGI_OPT_IMMEDIATE},
         {
                 ...
                 uwsgi_opt_true, &uwsgi.autoload, UWSGI_OPT_IMMEDIATE}, {"dlopen",
                                                                         ...
                                                                         uwsgi_opt_load_dl, NULL, UWSGI_OPT_IMMEDIATE},
         {"allowed-modifiers",
